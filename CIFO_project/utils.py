...
def two_point_crossover(p1_r, p2_r, random_state):
    ...
    point2 = random_state.randint(point1, len_)
    off1_r = np.concatenate((p1_r[0:point1], p2_r[point1:point2], p1_r[point2+1:len_]))
    off2_r = np.concatenate((p2_r[0:point1], p1_r[point1:point2], p2_r[point2 + 1:len_]))
    return off1_r, off2_r
